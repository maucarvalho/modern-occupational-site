...
const About = () => {
  const features = [
    {
      icon: <Heart className="w-6 h-6 text-therapeutic-500" />,
    ...
    {
      icon: <Sparkles className="w-6 h-6 text-therapeutic-500" />,
  ...
  return (
    <section id="about" className="bg-therapeutic-50 overflow-hidden">
      <div className="section-container">
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6" style={{ animationDelay: '0.2s' }}>
            <h3 className="text-2xl md:text-3xl font-medium text-therapeutic-800 animate-fade-up">Nossa Missão</h3>
            <p className="text-therapeutic-700 animate-fade-up" style={{ animationDelay: '0.3s' }}>
            ...
            <p className="text-therapeutic-700 animate-fade-up" style={{ animationDelay: '0.4s' }}>
            ...
            <p className="text-therapeutic-700 animate-fade-up" style={{ animationDelay: '0.5s' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="bg-therapeutic-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                  {feature.icon}
                </div>
                <h4 className="text-therapeutic-800 text-lg font-medium mb-2">
                  {feature.title}
                </h4>
                <p className="text-therapeutic-600 text-sm">
                  {feature.description}
                </p>
              </div>
            ))}
