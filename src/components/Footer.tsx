...
const Footer = () => {
  ...
  return (
    <footer className="bg-pastel-800 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Brand */}
          <div>
            <div className="text-2xl font-display font-medium mb-4">Terapia Ocupacional</div>
            <p className="text-pastel-200 mb-6">
              Dedicados a restaurar e desenvolver as habilidades essenciais para a independência e qualidade de vida.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.tiktok.com/@to.nataliefonseca" className="text-pastel-200 hover:text-white transition-colors" aria-label="TikTok">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M16.75 4.001c1.286 1.08 2.853 1.852 4.6 2.135v3.47a9.257 9.257 0 01-4.607-1.495v6.579a6.381 6.381 0 01-6.388 6.31 6.386 6.386 0 01-3.887-11.456 6.388 6.388 0 016.372-.578V12.42a3.026 3.026 0 00-1.47-.379 3.033 3.033 0 00-3.033 3.03 3.03 3.03 0 003.033 3.033 3.026 3.026 0 003.026-3.026V2h3.354v2.001z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/to.nataliefonseca" className="text-pastel-200 hover:text-white transition-colors" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="https://api.whatsapp.com/send/?phone=5553991035330&text&type=phone_number&app_absent=0" className="text-pastel-200 hover:text-white transition-colors" aria-label="WhatsApp">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <ul className="space-y-2">
                {column.links.map((link, linkIndex) => (
                  <li key={linkIndex}>
                    <a 
                      href={link.href} 
                      className="text-pastel-200 hover:text-white transition-colors"
                    >
                      {link.name}
                    </a>
                  </li>
